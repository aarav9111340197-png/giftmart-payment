...
<head>
    ...
    <title>Watchpays Payout Sandbox Simulator</title>
...
<body>
    ...
    <div class="sandbox-card">
        ...
        <h2 class="title">Watchpays Payout</h2>
        <p class="subtitle">Simulate the callback approval/failure response for withdrawal request.</p>
        ...
        <div class="details-box">
            ...
            <div class="detail-row">
                ...
                <span class="val"><?php echo htmlspecialchars($payload['transaction_id']); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="val"><?php echo htmlspecialchars($payload['bank_name']) . ' (' . htmlspecialchars($payload['ifsc']) . ')'; ?></span>
            </div>
            <div class="detail-row">
                <span class="label">Account Number</span>
                <span class="val"><?php echo htmlspecialchars($payload['account_number']); ?></span>
            </div>
            <div class="detail-row">
        ...
        <div class="btn-container">
            <form action="payout_sandbox_trigger.php" method="POST">
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fa-solid fa-circle-check"></i> Approve & Process Transfer
                </button>
            </form>
            ...
            <form action="payout_sandbox_trigger.php" method="POST">
                ...
                <button type="submit" class="btn btn-danger">
                    <i class="fa-solid fa-circle-xmark"></i> Reject & Fail Transfer
                </button>
            </form>

            <a href="payout.php" class="btn btn-cancel">Cancel & Go Back</a>
        </div>
    </div>
